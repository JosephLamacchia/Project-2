...
import { ToggleDisplayService } from 'src/services/toggle-display.service';
...
export class LoginPageComponent implements OnInit{
  ...
  constructor(private displayService: ToggleDisplayService,private loginServ: LoginmatchService, private router :Router) { };
